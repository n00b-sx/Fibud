<!DOCTYPE html>
<html lang="id" class="h-full bg-[#F8FAFC] font-sans antialiased">
<head>
    <meta charset="utf-8">
...
<body class="bg-[#F8FAFC] text-gray-900 min-h-screen">
    ...
    <div class="max-w-[85rem] mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex flex-col lg:flex-row gap-6 py-6">
            ...
            <!-- Sidebar (Green Container #50b476, No Border, No Shadow, Rounded-XL) -->
            <div id="application-sidebar" class="hs-overlay [--auto-close:lg] hs-overlay-open:translate-x-0 -translate-x-full fixed top-0 start-0 bottom-0 z-60 w-64 bg-[#50b476] overflow-y-auto lg:block lg:static lg:translate-x-0 lg:z-10 lg:w-64 lg:shrink-0 rounded-xl p-4 shadow-none border-none transition-all duration-300">
                <div class="flex items-center justify-between pb-4 mb-4 border-b border-white/20 lg:hidden">
                    <span class="font-semibold text-white">Menu Utama</span>
                    <button type="button" class="p-1 inline-flex justify-center items-center rounded-lg text-white/80 hover:bg-white/20" data-hs-overlay="#application-sidebar">
                ...
                <div class="mt-8 pt-4 border-t border-white/20">
                    <div class="p-3 bg-white/15 rounded-xl border border-white/20">
                        <p class="text-xs font-semibold text-white">Mode Lokal</p>
                        <p class="text-xs text-emerald-100 mt-0.5">Single user tanpa autentikasi.</p>
                    </div>
                </div>
            </div>
            <!-- End Sidebar -->
