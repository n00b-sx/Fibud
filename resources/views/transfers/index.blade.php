...
<div class="space-y-6">
    ...
    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
            ...
            <p class="text-xs sm:text-sm text-gray-600">Pindahkan dana antar rekening bank atau top up dompet digital dengan pencatatan otomatis</p>
        </div>
        <div>
            <button type="button" class="py-2 px-3.5 inline-flex items-center gap-x-2 text-sm font-medium rounded-lg border border-transparent bg-[#66BB6A] text-white hover:bg-[#52A456] shadow-sm transition" data-hs-overlay="#hs-add-transfer-modal">
    ...
    <div class="hs-overlay-open:mt-7 hs-overlay-open:opacity-100 hs-overlay-open:duration-500 opacity-0 transition-all sm:max-w-lg sm:w-full m-3 sm:mx-auto min-h-[calc(100%-3.5rem)] flex items-center">
        <div class="w-full flex flex-col modal-glass rounded-2xl pointer-events-auto overflow-hidden">
            <div class="flex justify-between items-center py-3.5 px-4 modal-glass-header">
                ...
                <button type="button" class="size-8 inline-flex justify-center items-center rounded-full border border-white/40 bg-white/60 text-gray-800 hover:bg-white/90 focus:outline-none transition shadow-2xs" data-hs-overlay="#hs-add-transfer-modal">
            ...
            <form action="{{ route('transfers.store') }}" method="POST">
                ...
                <div class="flex justify-end gap-x-2 py-3 px-4 modal-glass-footer">
                    ...
                    <button type="submit" class="py-2 px-3 text-sm font-medium rounded-lg bg-[#66BB6A] text-white hover:bg-[#52A456] transition shadow-sm">Proses Mutasi</button>
                </div>
            </form>
        </div>
    </div>
